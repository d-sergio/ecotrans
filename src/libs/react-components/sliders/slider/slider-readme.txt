...
friction: 5,    //см. ниже
disablePageScroll: 10, //см. ниже
disableSliderScroll: 20, //см. ниже
...
disablePageScroll - для touch-событий. Если пользователь сдвинул карусель
больше, чем на указанное количество пикселей, то вертикальная прокрутка
страницы блокируется (10 по умолчанию).

disableSliderScroll - для touch-событий. Если пользователь прокрутил
страницу больше, чем на указанное количество пикселей, то слайдера блокируется
(10 по умолчанию).
